...
const RichTwitterEmbed = ({ tweetId, url }: { tweetId: string, url: string }) => {
  ...
  if (loading) {
    return (
      <div className="my-2 p-2 border border-gray-200 rounded-lg bg-white max-w-sm animate-pulse">
  ...
  if (error || !tweetData) {
    return (
      <div className="my-2 p-2 border border-gray-200 rounded-lg bg-gray-50 max-w-sm">
        <div className="flex items-center space-x-2 mb-2">
          <div className="w-4 h-4 bg-black rounded-sm flex items-center justify-center">
            <span className="text-white text-xs font-bold">𝕏</span>
          </div>
          <span className="text-xs font-medium text-gray-700">Twitter Post</span>
        </div>
        ...
        <a
          ...
          className="inline-flex items-center space-x-1 px-2 py-1 bg-black text-white rounded-md hover:bg-gray-800 transition-colors text-xs font-medium"
  ...
  return (
    <div className="my-2 border border-gray-200 rounded-lg bg-white max-w-sm shadow-sm hover:shadow-md transition-shadow">
      <div className="p-2">
        ...
        {tweetData.text && (
          <div className="mb-2">
            <p className="text-gray-900 text-xs leading-normal whitespace-pre-wrap">
              {tweetData.text}
            </p>
          </div>
        )}
          ...
          <div className="flex items-center justify-between pt-2 border-t border-gray-100">
            <div className="flex items-center space-x-4">
              ...
              <a
                ...
                onClick={(e) => e.stopPropagation()}
              >
                <svg viewBox="0 0 24 24" className="w-3 h-3 fill-current group-hover:fill-blue-500">
                  <path d="M1.751 10c0-4.42 3.584-8 8.005-8h4.366c4.49 0 8.129 3.64 8.129 8.13 0 2.96-1.607 5.68-4.196 7.11l-8.054 4.46v-3.69h-.067c-4.49.1-8.183-3.51-8.183-8.01z"/>
                </svg>
                <span className="text-xs">{formatCount(tweetData.public_metrics.reply_count)}</span>
              </a>
              ...
              <a
                ...
                onClick={(e) => e.stopPropagation()}
              >
                <svg viewBox="0 0 24 24" className="w-3 h-3 fill-current group-hover:fill-green-500">
                ...
                <span className="text-xs">{formatCount(tweetData.public_metrics.retweet_count)}</span>
              </a>
              ...
              <a
                ...
                onClick={(e) => e.stopPropagation()}
              >
                <svg viewBox="0 0 24 24" className="w-3 h-3 fill-current group-hover:fill-red-500">
                  <path d="M20.884 13.19c-1.351 2.48-4.001 5.12-8.379 7.67l-.503.3-.504-.3c-4.379-2.55-7.029-5.19-8.382-7.67-1.36-2.5-1.41-4.86-.514-6.67.887-1.79 2.647-2.91 4.601-3.01 1.651-.09 3.368.56 4.798 2.01 1.429-1.45 3.146-2.1 4.796-2.01 1.954.1 3.714 1.22 4.601 3.01.896 1.81.846 4.17-.514 6.67z"/>
                </svg>
                <span className="text-xs">{formatCount(tweetData.public_metrics.like_count)}</span>
              </a>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <a
                ...
                onClick={(e) => e.stopPropagation()}
              >
                {tweetData.created_at ? formatTime(tweetData.created_at) : 'View'}
              </a>
              <button
                onClick={(e) => {
                  e.stopPropagation()
